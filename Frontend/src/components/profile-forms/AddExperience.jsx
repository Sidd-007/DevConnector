            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                >
                    <div className='px-12 pb-10'>
                        ...
                        <div className="mt-2">
                            <textarea
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 8 dark:placeholder-gray-800 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                name="description"
                                cols="30"
                                rows="5"
